<template>
  <div
    class="mb-2 border-b border-gray-200 text-center text-sm font-medium text-gray-500 dark:border-gray-700 dark:text-gray-400">
...
const links = computed(() => [
  ...
  { label: 'Info', name: 'admin-event-id-info' },
